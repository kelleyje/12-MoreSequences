...
def run_test_generate_points_on_circle():
    ...
    # Test 2:
    expected = [rg.Point(300.0, 200.0),  # All numbers are approximate.
                rg.Point(100.0, 200.0)]
...
def run_test_draw_points_on_circle():
    ...
    # Test 4:
    title = 'DRAW_POINTS_ON_CIRCLE, test 4:  5 magenta dots.'
    window = rg.RoseWindow(600, 600, title)
    circle = rg.Circle(rg.Point(100, 100), 50)
    draw_points_on_circle(window, circle, 5, 'magenta')
    window.close_on_mouse_click()
...
def run_test_pizza():
    ...
    # Test 2:
    title = 'PIZZA test 2:  4 slices, thin (thickness=4) lime green lines.'
    window = rg.RoseWindow(600, 600, title)
    circle = rg.Circle(rg.Point(250, 350), 200)
    circle.outline_thickness = 4
    pizza(window, circle, 4, 'lime green', 4)
    window.close_on_mouse_click()
...
def run_test_polygon():
    ...
    # Tests 3:
    title = 'POLYGON test 3:  20 segments with thick black lines'
    window = rg.RoseWindow(600, 600, title)

    circle = rg.Circle(rg.Point(300, 300), 250)
    circle.outline_thickness = 3
    polygon(window, circle, 20, 'blue', 10)
...
def run_test_fancy_polygon():
    ...
    title = 'FANCY POLYGON test 4:  100 lime green lines on red circle, hops = 10.'
    window = rg.RoseWindow(600, 600, title)

    circle = rg.Circle(rg.Point(300, 300), 250)
    circle.fill_color = 'red'
    fancy_polygon(window, circle, 100, 33, 'lime green', 5)
    window.close_on_mouse_click()
...
def fancy_polygon(window, circle, number_of_lines, hops_to_next_point, color,
    ...
    last = 0
    next = (last + hops_to_next_point) % len(points)

    for _ in range(number_of_lines):
        note = rg.Line(points[last], points[next])
        note.color = color
        note.thickness = thickness
